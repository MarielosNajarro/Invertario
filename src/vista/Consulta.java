...
public class Consulta extends JFrame {
    ...
    private static final int ANCHO = 130, ALTO = 30;
    ...
    public final void agregarLabels() {
        ...
        lblStock = new JLabel("Strock");
        lblExistencia = new JLabel("Stock en tienda");
        lblCodigo.setBounds(10, 10, ANCHO, ALTO);
        lblMarca.setBounds(10, 60, ANCHO, ALTO);
        lblStock.setBounds(10, 100, ANCHO, ALTO);
        lblExistencia.setBounds(10, 140, ANCHO, ALTO);
    }
    ...
    public final void formulario() {
        ...
        codigo.setBounds(140,10, ANCHO, ALTO);
        marca.setBounds(140,60, ANCHO, ALTO);
        stock.setBounds(140,100, ANCHO, ALTO);
        si.setBounds(140,140, 50,ALTO);
        no.setBounds(210,140, 50,ALTO);
        
        buscar.setBounds(300, 10, ANCHO, ALTO);
        insertar.setBounds(10, 210, ANCHO, ALTO);
        actualizar.setBounds(150, 210, ANCHO, ALTO);
        eliminar.setBounds(300, 210, ANCHO, ALTO);
        limpiar.setBounds(450, 210, ANCHO, ALTO);
        resultados = new JTable();
        ...
        insertar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.create(f)) {
                    ...
                    JOptionPane.showConfirmDialog(null, "Ocurrio un problema al momento de crear el filtro");
                }
            }
        });
        ...
        actualizar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.update(f)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un error al momento de modificar el filtro");
                }
            }
        ...
        eliminar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fd.delete(codigo.getText())) {
                    ...
                    JOptionPane.showMessageDialog(null, "Ocurrio un error al momento de eliminar el filtro");
                }
            }
        });
